...
## Last step : Learning the workflow

1. Created a `dev` branch from `main`.
2. Made additional commits in `dev`.
3. Pushed `dev` to GitHub.
4. Created a Pull Request and merged `dev` back into `main`.

![creating new branch](images/15.png)
